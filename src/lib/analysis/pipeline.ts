    ...
    properties: {
      ...
      businessModel: {
        ...
        properties: {
          ...
          revenueStreams: { type: "array" as const, items: { type: "string" as const } },
          costStructure: { type: "array" as const, items: { type: "string" as const } },
          keyPartners: { type: "array" as const, items: { type: "string" as const } },
          keyActivities: { type: "array" as const, items: { type: "string" as const } },
        },
        required: ["type", "revenueStreams"] as const,
      },
      valueProposition: {
        type: "object" as const,
        properties: {
          ...
          solutions: { type: "array" as const, items: { type: "string" as const } },
          uniqueDifferentiators: { type: "array" as const, items: { type: "string" as const } },
        },
        required: ["headline", "description", "painPoints", "solutions", "uniqueDifferentiators"] as const,
      },
      market: {
        type: "object" as const,
        properties: {
        ...
        required: ["targetAudience"] as const,
      },
      team: {
        type: "object" as const,
        properties: {
          ...
          teamStrengths: { type: "array" as const, items: { type: "string" as const } },
          advisors: { type: "array" as const, items: { type: "string" as const } },
        },
        required: ["members"] as const,
      },
      financials: {
        type: "object" as const,
        properties: {
          stage: { type: "string" as const },
          fundingHistory: { type: "array" as const, items: { type: "string" as const } },
          currentAsk: { type: "string" as const },
          keyMetrics: {
            type: "array" as const,
            items: {
              type: "object" as const,
          ...
          projections: { type: "string" as const },
        },
      ...
      brandEssence: {
        ...
        properties: {
          ...
          coreValues: { type: "array" as const, items: { type: "string" as const } },
          tagline: { type: "string" as const },
        },
        required: ["mission", "tone"] as const,
      },
